...
@Component
public class BuasnAirSchedulers {
    private Long idx;
    ...
    public void PerDay() throws InterruptedException {
        ...
        try {
            ...
            // GET 요청 보내기
            String response = restTemplate.getForObject("http://localhost:8085/air/busan", String.class);
            ...
            realTimeErrorRepository.save(new RealTimeError(LocalDateTime.now(), "AIR_BUSAN_"+(idx++), e.getMessage()));
